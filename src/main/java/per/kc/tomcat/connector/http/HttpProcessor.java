...
import per.kc.tomcat.servlet.StaticResourceProcessor;
...
public class HttpProcessor {
     ...
     * 当前目录的属性管理器
     */
    protected StringManager sm = StringManager.getManager("per.kc.tomcat.connector.http");
    ...
    public void process(Socket socket) {
        ...
        try {
            ...
            response.setHeader("Server", "KC-Tomcat Container");

            parseRequest(input, output);
            parseHeaders(input);

            // 判断这次请求是请求Servlet还是请求静态资源
